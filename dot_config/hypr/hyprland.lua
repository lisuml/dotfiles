...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("~/.local/bin/bw-picker"))
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd("~/.local/bin/bw-picker --target menu"))
hl.bind(mainMod .. " + CTRL + B", hl.dsp.exec_cmd("~/.local/bin/bw-open"))
